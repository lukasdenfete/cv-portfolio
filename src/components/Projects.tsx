...
import { SiMysql, SiTailwindcss, SiTypescript, SiDotnet, SiJavascript, SiCsharp } from "react-icons/si";
...
function Projects() {
    const projectList = [
        { title: "Whiskey Sour Carparts", 
          description: "Hobbyprojekt: en e-handelsplattform med communitydel. Byggd med ASP.NET Core MVC, C#, Entity Framework Core och databas i Azure SQL. Frontend är byggt med Razor Views och Bootstrap. Funktioner inkluderar användarhantering, följarsystem, DMs, trådar och kommentarer, notiser, produktsökning och varukorg.",
          badges: [
        ...
        { title: "Responsiv företagswebbplats",
            ...
            badges: [
              {Icon: FaHtml5, name: "HTML", color: COLORS.HTML},
              {Icon: FaCss3Alt, name: "CSS", color: COLORS.CSS},
              {Icon: SiJavascript, name: "JavaScript", color: COLORS.JAVASCRIPT},
              {Icon: FaVuejs, name: "Vue.js", color: COLORS.VUEJS}
         ]
          },
        { title: "Podcastprojektet", 
          description: "Skolprojekt: en desktopapplikation för att hantera och organisera RSS-flöden. Asynkron hämtning av data, LINQ-hantering av samlingar samt strukturerad validering och exception-hantering. Utvecklad i C#/.NET med Windows Forms.",
          badges: [
            {Icon: SiCsharp, color: COLORS.CSHARP},
            {Icon: SiDotnet, color: COLORS.DOTNET}, 
        ...
        { title: "CV-Portfolio", 
          ...
          badges: [
            {Icon: DiReact, name: "React", color: COLORS.REACT},
            {Icon: SiTailwindcss, name: "Tailwind", color: COLORS.TAILWIND},
            {Icon: SiTypescript, name: "TypeScript", color: COLORS.TYPESCRIPT}
          ] },
        { title: "Men in Black", 
