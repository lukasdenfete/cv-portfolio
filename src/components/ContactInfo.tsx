    ...
    return (
        <div className="flex flex-col space-y-3">           
            <p className="flex items-center justify-center">
                ...
                <a href="mailto:lukas.rosendahl@hotmail.com" className='hover:font-bold transition-all duration-200'>
            ...
            <div className="flex items-center justify-center gap-2">
                ...
                <a target="_blank" href="https://github.com/lukasdenfete" rel="noopener noreferrer" aria-label="GitHub">
